...
export default function Signup(props){
    ...
    React.useEffect(function(){
        axios.get(process.env.REACT_APP_BACKEND +'/getUsernames?secret=' + props.secret)
            .then(response => {
                setUsernames(response.data);
            })
            .catch(() => navigate('/error'));
    },[navigate,props.secret])
    ...
    function addStudent(event)
    {
        ...
        axios.post(process.env.REACT_APP_BACKEND +'/add?secret=' + props.secret, student)
