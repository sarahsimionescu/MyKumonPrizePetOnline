...
export default function Student(props){
    ...
    React.useEffect(function(){
        axios.get(process.env.REACT_APP_BACKEND +'/get?username=' + username + '&secret=' + props.secret)
            .then(response => {
                var mathdates = []
                var readingdates = []
    ...
    },[username,navigate,props.secret])
    ...
    function handleDone(event)
    {
        ...
        axios.post(process.env.REACT_APP_BACKEND +'/update?username=' + username + '&secret=' + props.secret,studentData)
        .then((response) => {
